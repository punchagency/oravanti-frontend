...
import { PortalAccessBadge } from "./components/portal-access-badge";
...
import { ConvertedClientsDataProvider, useConvertedClientsData } from "./converted-clients-data-context";
...
function ConvertedClientsPageContent() {
  const {
    clients,
    isLoading,
    total,
...
export function ConvertedClientsPage() {
  return (
    <ConvertedClientsDataProvider>
      <ConvertedClientsPageContent />
    </ConvertedClientsDataProvider>
  );
}

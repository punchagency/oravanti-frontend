...
export const dummyStaffMembers: StaffMember[] = [
  {
    ...
    caseloadMax: 10,
    practiceAreas: [
      { id: "pa-immigration", name: "Immigration" },
      { id: "pa-family-law", name: "Family law" },
    ],
  ...
  },
  {
    ...
    caseloadMax: 7,
    practiceAreas: [
      { id: "pa-business", name: "Business" },
      { id: "pa-employment", name: "Employment" },
    ],
    teams: [{ id: "team-1", name: "Immigration Team A" }],
  ...
  },
  {
    ...
    caseloadMax: 8,
    practiceAreas: [
      { id: "pa-real-estate", name: "Real estate" },
      { id: "pa-estate-planning", name: "Estate planning" },
    ],
  ...
  },
  {
    ...
    caseloadMax: 7,
    practiceAreas: [
      { id: "pa-criminal-defense", name: "Criminal defense" },
      { id: "pa-personal-injury", name: "Personal injury" },
    ],
    teams: [],

...
/**
 * Confirmation dialog shown before marking a step as complete.
 *
 * Allows the user to add optional notes explaining what was done.
 * Notes are passed back via the onConfirm callback, which is
 * responsible for calling the underlying mutation.
 */
            ...
            <Dialog.Body>
              <VStack gap={3} align="stretch">
                <Text fontSize="12px" color="fg.muted">
                  Mark "<Text as="span" fontWeight="500" color="fg">{stepTitle}</Text>" as complete?
                </Text>
